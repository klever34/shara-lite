...
import {IReceipt, modelName} from 'app-v2/models/Receipt';
...
import {Customer, Payment} from 'types-v2/app';
...
import {restockProduct} from 'app-v2/services/ProductService';
